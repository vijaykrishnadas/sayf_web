...
‍
Please read the Privacy Policy carefully prior to using or registering on the Platform or accessing/availing the services on the Platform including interalia in relation to mutual fund distribution, stockbroking services, investment advisory services, and KRA/KYC verification (“Services”).<br/><br/>
‍
...
If You choose to post messages on our message boards, chat rooms or other message areas or leave feedback, We will collect and store such information You provide to Us. We retain this information as necessary to resolve disputes, provide customer support, respond to queries and inquires, and troubleshoot problems and improve the Services.<br/><br/>

If You send us correspondence, such as emails or letters, or if other users or third parties send us correspondence about Your activities or postings on the Platform, We may collect and retain such information into a file specific to You for responding to Your request and addressing concerns in relation to Your use of the Platform. We shall be entitled to retain Your Personal Information and other information for such duration as may be required for the purposes specified hereunder and will be used by Us only in accordance with this Privacy Policy.<br/><br/>

Use of Your Information<br/><br/>
We use the Personal Information and other Non-Personal Information, for the following:<br/><br/>
(i) to provide and improve the Services on the Platform that You request;<br/>
(ii) to resolve disputes and troubleshoot problems;<br/>
...
(iv) collect money from You in relation to the Services,<br/>
(v) inform You about online and offline offers, products, services, and updates;<br/>
(vi) customize Your experience on the Platform or share marketing material with You;<br/>
(vii) to detect, prevent and protect Us from any errors, fraud and other criminal or prohibited activity on the Platform;<br/>
(viii) enforce and inform about our terms and conditions;<br/>
(ix) to process and fulfil Your request for Services or respond to Your comments, and queries on the Platform;<br/>
(x) to contact You;<br/>
(xi) to allow Our business partners and/or associates to present customised messages to You;<br/>
(xii) to communicate important notices or changes in the Services provided by the Company, use of the Platform and the terms/policies which govern the relationship between You and the Company and with Our affiliates as set out in paragraph 3 below for providing services to You; and<br/>
(xiii) for any other purpose after obtaining Your consent at the time of collection.
You also specifically agree and consent to Us collecting, storing, processing, transferring and sharing information (including Personal Information) related to You with third parties solely for the purpose of processing your transaction requests for the Services.<br/>
‍
You also specifically agree and consent to Us collecting, storing, processing, transferring and sharing information (including Personal Information) related to You with third parties solely for the purpose of processing your transaction requests for the Services.<br/><br/>

In addition to the above, We identify and use Your IP address to help diagnose problems with Our server, resolve such problems and administer the Platform. Your IP address is also used to help identify you and to gather broad demographic information.<br/><br/>
...
Unless and until, You explicitly give Your consent to Us, to do so, We will not share Your Personal Information with another user of the Platform and vice versa.<br/><br/>


Sharing of information
We may make Your Personal Information and/or other Non-Personal Information available to Our affiliates to enable them to provide Services through the Platform to You. Please note that all information shared with our affiliates or made available to our affiliates will be governed by the terms of this Privacy Policy.<br/><br/>

In addition to the Personal Information and in order to provide Services to You, We may also collect Your Aadhaar, finger – print details and signature solely for completing the account opening procedures and authenticating Your transactions on the Platform. The act of providing Your Aadhaar is voluntary in nature and the Company, hereby agrees and acknowledges that they will collect, use and store such details in compliance with applicable laws and this Privacy Policy.We may also disclose Your Personal Information to third party vendors, consultants, and other service providers who work for the Company, who are bound by contractual obligations to keep such personal information confidential and use it only for the purposes for which We disclose it to them. This disclosure may be required for Us, for instance, to provide You access to Our Services and process payments including validation of Your bank accounts, to facilitate and assist Our marketing and advertising activities/initiatives, for undertaking auditing or data analysis, or to prevent, detect, mitigate, and investigate fraudulent or illegal activities related to Our Services. We do not disclose Your Personal Information to third parties for their marketing and advertising purposes without Your explicit consent.<br/><br/>

The Company may disclose Your information, to the extent necessary:<br/><br/>

(i) to comply with laws and to respond to lawful requests and legal process,<br/>
(ii) to protect the rights and property of the Company, Our users, and others, including to enforce the Terms, and<br/>
(iii) in an emergency to protect the personal safety and assets of the Company, the users, or any person. In such an event the Company is in no manner responsible for informing You or seeking Your approval or consent.<br/>
We and Our affiliates may, in compliance with applicable laws, share/transfer/assign all of Your Personal Information and other information with any other business entit(ies), in the event of a merger, sale, re-organization, amalgamation, joint ventures, assignment, restructuring of business or transfer or disposition of all or any portion of Our business.<br/><br/>


Connecting your email account
You may also choose to provide Your explicit consent to connect/integrate Your email account(s) with Your account on the Platform by clicking on the authentication email sent by the Company on Your registered email address. You will be expressly asked in each case whether You want to connect Your email address with Your account on the Platform. You can also choose to enable Our access to one or more of Your email accounts by connecting such account(s) with Your account on the Platform.<br/><br/>


Once connected, the Platform will securely access and analyze the emails and passwords, if any to populate and track Your investments details and history including those made through the account on the Platform and consolidate them at one place.<br/><br/>


Such data obtained by this integration will be used by the Company solely for providing the Services and improving Your experience of the features of the Platform and to consolidate your investment details and history. The Company hereby agrees and acknowledges that it shall not use or transfer any data or information received from the integration of the email addresses with the account on the Platform to third parties for serving ads, including retargeting, personalized, or interest-based advertising. Further, Company hereby undertakes to ensure that its employees, agents, contractors, and successors shall at all times comply with applicable laws.<br/><br/>
